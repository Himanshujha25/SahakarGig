...
import {
  ...
  Clock, Award, Lock, CheckCircle2, ArrowUpRight
} from 'lucide-react';
...
const STATS = [
  ...
  { key: 'bookings',    label: 'Bookings Completed',   Icon: CalendarCheck },
  { key: 'cooperatives',label: 'Cooperatives',          Icon: Handshake },
    ...
    <div className="min-h-screen flex flex-col bg-[#f8f9ff] text-[#0d1c2e] antialiased selection:bg-[#00288e] selection:text-white">
      ...
      <main className="flex-grow">
        ...
        <section className="relative pt-18 pb-16 px-6 flex flex-col items-center text-center overflow-hidden">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 backdrop-blur-md border border-[#c4c5d5]/60 text-[#0d1c2e] text-[12px] font-bold tracking-tight shadow-[0_2px_14px_rgba(0,40,142,0.06)] hover:border-[#00288e]/40 hover:shadow-[0_4px_18px_rgba(0,40,142,0.10)] transition-all duration-300 mb-6 cursor-default group">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Cooperative Gig Platform</span>
            <span className="w-1 h-1 rounded-full bg-[#c4c5d5]" />
            <span className="text-[#00288e]">Ministry of Cooperation Initiative</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              { Icon: BadgeCheck,  label: 'Verified by Cooperative', bg: 'bg-[#e6f9ec]', tc: 'text-[#006d30]', border: 'border-[#006d30]/20' },
              { Icon: ShieldCheck, label: 'Secure Escrow Payments',   bg: 'bg-[#e8edff]', tc: 'text-[#00288e]', border: 'border-[#00288e]/20' },
              { Icon: Zap,         label: 'Instant Emergency Booking',bg: 'bg-[#fff3e0]', tc: 'text-[#6b4200]', border: 'border-[#6b4200]/20' },
            ].map(({ Icon, label, bg, tc, border }) => (
              <span
                key={label}
                className={`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full ${bg} ${tc} ${border} border text-[12.5px] font-semibold shadow-2xs hover:scale-105 transition-transform duration-200 cursor-default`}
              >
        ...
        <section id="services" className="max-w-[1280px] mx-auto px-6 sm:px-8 py-14">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5">
            ...
            {SMALL_CATS.map(({ Icon, label, sub }) => (
              <div
                key={label}
                className="group relative overflow-hidden rounded-2xl sm:rounded-3xl border border-[#c4c5d5]/50 bg-white cursor-pointer flex flex-col items-center justify-center gap-3 p-5 sm:p-6 aspect-square shadow-sm hover:shadow-[0_12px_36px_rgba(0,40,142,0.12)] hover:-translate-y-1.5 hover:border-[#00288e]/40 transition-all duration-300"
              >
                <div className="w-13 h-13 rounded-2xl bg-[#f8f9ff] border border-[#c4c5d5]/50 text-[#00288e] flex items-center justify-center group-hover:bg-[#00288e] group-hover:text-white group-hover:border-[#00288e] group-hover:shadow-[0_8px_20px_rgba(0,40,142,0.25)] group-hover:scale-110 transition-all duration-300">
            ...
            <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 divide-y sm:divide-y-0 sm:divide-x divide-[#e2e6ff]/80">
              {STATS.map(({ key, label, Icon }, index) => (
                <div key={label} className={`flex flex-col items-center text-center group ${index > 0 ? 'sm:pl-6 pt-4 sm:pt-0' : ''}`}>
                  <div className="w-13 h-13 rounded-2xl bg-[#e8edff] border border-primary/20 text-[#00288e] flex items-center justify-center mb-3.5 group-hover:bg-[#00288e] group-hover:text-white group-hover:scale-110 group-hover:shadow-[0_8px_20px_rgba(0,40,142,0.25)] transition-all duration-300">
            ...
            {FEATURES.map(({ Icon, title, desc }) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-[#e8edff] border border-primary/20 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-[#00288e] group-hover:shadow-[0_8px_24px_rgba(0,40,142,0.3)] transition-all duration-300">
                    <Icon size={26} strokeWidth={1.8} className="text-[#00288e] group-hover:text-white transition-colors duration-300" />
                  </div>
