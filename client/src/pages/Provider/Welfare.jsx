                ...
                <div className="flex gap-2">
                  ...
                  {form.eShramId && welfareData?.eShramVerificationStatus !== 'govt_verified' && (
                    <button onClick={verifyEShram} disabled={verifying}
                      className="shrink-0 h-11 px-4 rounded-xl border border-primary/25 bg-[#e8edff] text-[#00288e] text-[12px] font-bold hover:border-primary hover:bg-[#d7e3ff] disabled:opacity-50 transition-all inline-flex items-center gap-1.5 cursor-pointer">
